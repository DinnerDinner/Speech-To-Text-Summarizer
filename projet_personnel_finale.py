...
def display_message(lang_choice, message_dict):
    ...
    return message_dict.get(language, message_dict['English'])  # Default to English if translation not available
...
def main(lang_choice):
    try:
        ...
        with open(PATH_TO_FILE, 'rb') as audio:
            ...
            loading_process = Process(target=loading_animation, args=(lang_choice,))
    ...
    # print(json_text_only)
        ...
        def pipeline_summarization():
            ...
            for i, chunk in enumerate(chunks, 1):
                ...
                corrected_summary = grammar_check(summary, lang_choice)
